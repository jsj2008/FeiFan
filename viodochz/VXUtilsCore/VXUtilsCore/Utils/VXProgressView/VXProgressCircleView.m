...
@implementation VXProgressCircleView
{
    float progress;
}
...
+(VXProgressCircleView*)circleWithColor:(UIColor*)color width:(CGFloat)width
{
    ...
    VXProgressCircleView *circle = [[VXProgressCircleView alloc] initWithFrame:CGRectMake(0, 0, width, width)];
    circle.color = color;
    return circle;
}
