...
#import "VXCutImageViewController.h"

#define BOUNDCE_DURATION 0.3f

@interface VXCutImageViewController ()
...
@implementation VXCutImageViewController
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(VXCutImageViewControllerDelegate)]) {
