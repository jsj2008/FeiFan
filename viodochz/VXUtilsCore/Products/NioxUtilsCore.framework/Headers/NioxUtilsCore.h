...
//  NioxUtilsCore
//
//  Created by duanxiaochen on 2016/11/14.
//  Copyright © 2016年 DC. All rights reserved.
//

#import <UIKit/UIKit.h>

//! Project version number for NioxUtilsCore.
FOUNDATION_EXPORT double NioxUtilsCoreVersionNumber;

//! Project version string for NioxUtilsCore.
FOUNDATION_EXPORT const unsigned char NioxUtilsCoreVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <NioxUtilsCore/PublicHeader.h>
...
#define APPDELEGATE_NXPViewDidAppearNotification @"APPDELEGATE_NXPViewDidAppearNotification"
