...
//  VXUtilsCore
//
//  Created by viodoc on 2016/11/14.
//  Copyright © 2016年 viodoc. All rights reserved.
//

#import <UIKit/UIKit.h>

//! Project version number for VXUtilsCore.
FOUNDATION_EXPORT double VXUtilsCoreVersionNumber;

//! Project version string for VXUtilsCore.
FOUNDATION_EXPORT const unsigned char VXUtilsCoreVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <VXUtilsCore/PublicHeader.h>
...
#define APPDELEGATE_VXPViewDidAppearNotification @"APPDELEGATE_VXPViewDidAppearNotification"
