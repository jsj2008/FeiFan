...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[NMTFPage class]]) {
    return NO;
  }
  NMTFPage *other = (NMTFPage *)anObject;
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"NMTFPage("];
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[NMTFDevice class]]) {
    return NO;
  }
  NMTFDevice *other = (NMTFDevice *)anObject;
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"NMTFDevice("];
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[NMTFReqHeader class]]) {
    return NO;
  }
  NMTFReqHeader *other = (NMTFReqHeader *)anObject;
    ...
    switch (fieldID)
    {
      ...
      case 8:
        if (fieldType == TType_STRUCT) {
          NMTFDevice *fieldValue = [[NMTFDevice alloc] init];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"NMTFReqHeader("];
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[NMTFRespHeader class]]) {
    return NO;
  }
  NMTFRespHeader *other = (NMTFRespHeader *)anObject;
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"NMTFRespHeader("];
...
@implementation NMTFMtBaseConstants
+ (void) initialize {
}
@end
